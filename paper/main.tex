...
%
Although SHERLOCK originally data contain 1 run only, we split them into 4 blocks
...
%
It is open question whether dimension reduction and learning of the shared
