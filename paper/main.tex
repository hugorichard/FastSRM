...
($\geq 0.18.0$), matplotlib ($\geq 2.0.0$), scikit-learn ($geq 0.23), 



Our API is very simple and reminiscent of the one used in scikit-learn with a clear documentation.
