...
therefore the empirical expected \textbf{XXX why expected ?} negative log-likelihood is given up to a constant independent of
$A_i$ and $S$ by:
\begin{align}
...
carried out, only the gradient with respect to $S$ remains \textbf{XXX WDYM ?}: $\sum_i
(S - A_i^{\top}\xb_i)$.
%
